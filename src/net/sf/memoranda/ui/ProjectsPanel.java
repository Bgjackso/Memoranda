...
public class ProjectsPanel extends JPanel implements ExpandablePanel {
	...
	ImageIcon expIcon =
		new ImageIcon(net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/exp_panel.png"));
	
	ImageIcon collIcon =
		new ImageIcon(net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/coll_panel.png"));
	...
	public Action newProjectAction = 
			new AbstractAction(Local.getString("New project") + "...",
	...
	public Action propertiesProjectAction =
			new AbstractAction(Local.getString("Project Properties") + "...",
	...
	public Action deleteProjectAction =
			new AbstractAction(Local.getString("Delete project") + "...",
	...
	public Action openProjectAction =
			new AbstractAction(Local.getString("Open project") + "...",
    ...
    // Actions that each option will perform. (The algorithms for the button functions) {
	void ppOpenB_actionPerformed(ActionEvent e) {
		projectsPPMenu.show(buttonsPanel,(int) (ppOpenB.getLocation().getX() + 24)
				- projectsPPMenu.getWidth(),(int) ppOpenB.getLocation().getY() + 24);
	}
	...
	//Currently there is a bug when deleting a project, unknown error
	...
	void ppProperties_actionPerformed(ActionEvent e) {
		Project prj = CurrentProject.get();//changed from prjTablePanel.getSelectedProject();
